 ...
 * For each bit 'i' in 'x', if it is set, the corresponding 32-bit word in 'r' will have all bits set;
 * otherwise, the corresponding word will have all bits unset.
 * 
 ...
 * 
 * @param r [in, out] 8-element array of 32-bit words, where one of the input arrays and the result will be stored.
